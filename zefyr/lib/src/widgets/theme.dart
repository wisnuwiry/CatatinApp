  ...
  factory AttributeTheme.fallback(
    ...
    switch (theme.platform) {
      ...
      case TargetPlatform.android:
        monospaceFontFamily = 'serif-monospace';
        break;
    ...
    return AttributeTheme(
      ...
      heading1: LineTheme(
        textStyle: defaultLineTheme.textStyle.copyWith(
          fontSize: defaultLineTheme.textStyle.fontSize + 24,
      ...
      heading2: LineTheme(
        textStyle: defaultLineTheme.textStyle.copyWith(
          fontSize: defaultLineTheme.textStyle.fontSize + 12,
          color: defaultLineTheme.textStyle.color.withOpacity(0.7),
          // height: 1.15,
          fontWeight: FontWeight.w500,
        ),
      ...
      heading3: LineTheme(
        textStyle: defaultLineTheme.textStyle.copyWith(
          fontSize: defaultLineTheme.textStyle.fontSize + 8,
          color: defaultLineTheme.textStyle.color.withOpacity(0.7),
          // height: 1.15,
          fontWeight: FontWeight.w500,
        ),
      ...
      code: BlockTheme(
        ...
        textStyle: TextStyle(
          ...
          fontSize: defaultLineTheme.textStyle.fontSize,
